    ...
    <div className="post-text">
      {segments.map((s, i) => {
        ...
        switch (s.type) {
          case 'link':
            return (
              <span key={i} className="facet-link">
                {slice}
              </span>
            );
          case 'mention':
            return (
              <span key={i} className="facet-mention">
                {slice}
              </span>
            );
          case 'tag':
            return (
              <span key={i} className="facet-tag">
                {slice}
              </span>
            );
          default:
...
function EmbedView({
      ...
      <div className="embed-quote">
        <div className="embed-quote-author">
          ...
          <span className="display-name">
            {qAuthor.displayName ?? qAuthor.handle}
          </span>
          <span className="handle">@{qAuthor.handle}</span>
          {qCreatedAt && (
            <span className="timestamp">
              · {relativeTime(qCreatedAt, now)}
            </span>
          )}
        </div>
  ...
  if (e.$type === 'app.bsky.embed.recordWithMedia#view') {
    return (
      <>
        <EmbedView embed={e.media} measureMode={measureMode} now={now} />
        <EmbedView
          embed={
            e.record
              ? { ...e.record, $type: 'app.bsky.embed.record#view' }
              : null
          }
          measureMode={measureMode}
          now={now}
  ...
  return (
    <div className="thread-parent">
      <div className="thread-parent-left">
        {src ? (
          <img
            className="post-avatar thread-parent-avatar"
            src={src}
            alt=""
          />
        ) : (
      ...
      <div className="thread-parent-content">
        <div className="post-author-line">
          ...
          <span className="timestamp">
            · {relativeTime(parent.createdAt, now)}
          </span>
        </div>
      ...
      <div className="post-card">
        {post.repostBy && (
          <div className="repost-indicator">
            🔁 {post.repostBy.displayName} reposted
          </div>
        )}
          ...
          <div className="post-content-col">
            ...
            <div className="post-engagement">
              <span className="engagement-item">
                💬 {compact(post.replyCount)}
              </span>
              <span className="engagement-item">
                🔁 {compact(post.repostCount)}
              </span>
              <span className="engagement-item">
